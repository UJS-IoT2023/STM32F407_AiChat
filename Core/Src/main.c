...
int main(void)
{
  ...
  if(ESP8266_SendCmd("AT+CWJAP=\"AEIOU\",\"12345abc\"\r\n", "WIFI GOT IP", 15000)) {
    lcd_clear(BLACK);
    lcd_show_string(10, 10, 220, 16, 16, "WiFi Connected!", WHITE);
    ESP8266_SendCmd("AT+CIFSR\r\n", "OK", 2000);
  } else {
    lcd_show_string(10, 30, 220, 16, 16, "WiFi Failed!", RED);
    // 可以选择死循环卡住，或者继续往下走
  }
  /* USER CODE END 2 */
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  {
    esp8266_rx_buffer[rx_index++] = (char)rx_data;
